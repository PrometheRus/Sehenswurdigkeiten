...
5. Запустить плейбук:
   ...
   ```
6. Настроить дашборд:
   1. Переходим на публичный адрес машины grafana <IP>:3000, логинимся под admin:admin, устанавливаем новый пароль
...
### Моя графана доступна по [ссылке](http://87.228.27.130:3000/d/rYdddlPWk/node-exporter-full). Креды: **viewer:viewer**, доступ из под 188.93.16.0/22